 ...
 */
export function checkWindow(): boolean {
  if (typeof window === "undefined") {
    warn("You are running in a non-browser environment. Resorted to `React.useState`.")
    return true
  } else {
    return false
  }
 ...
 */
export function checkBrowserStorage(): boolean {
 ...
 */
export function checkIfSerializable(value: string): boolean {
  try {
